...
// Timeline page ka accent color — MENU / CONTACT / hamburger sabka
// isi color me switch hota hai jab route /timeline ho.
const TIMELINE_ACCENT = "#FFDC00";
    ...
    <header className={styles["header-main"]}>
      <div className={styles["header-wrapper"]}>
        ...
        <nav className={styles["header-left"]}>
          <a
            href="#"
            style={isTimelinePage ? { color: TIMELINE_ACCENT } : undefined}
            onClick={(e) => {
              e.preventDefault();
              setIsMenuOpen(true);
            }}
