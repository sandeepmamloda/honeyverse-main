...
/* Extra props (onClick, type, etc.) spread onto the tag so it can
   double up as an interactive element, like the return-link button. */
const Reveal = ({
  children,
  className = "",
  ready = false,
...
const Heromoodboard = ({ onReturnToGallery }) => {
  ...
  const handleReturnClick = () => {
    // agar parent ne apna khud ka handler diya hai to wo bhi chalega
    onReturnToGallery?.();
    router.push("/gallery");
  };
