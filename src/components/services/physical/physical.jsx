...
/* ══════════════════════════════
   FADE-ONLY VARIANT (no clip-path)
   Un elements ke liye jinke andar koi overflowing child hai (jaise
   sys-badge jo translateY(50%) se apne parent ke box ke bahar nikalta
   hai) — clip-path use nahi karte kyunki wo hamesha apne box tak
   content ko clip kar deta hai, chahe final state "no clip" jaisa ho.
   Sirf opacity + transform se fade/slide hota hai — koi masking nahi.
══════════════════════════════ */
const RevealFade = ({
  children,
  className = "",
    ...
    <section className={styles["physical-main"]}>
      ...
      <div className={styles["main-grid"]}>
        ...
        {/* Left: Sticky Image Showcase with Yellow Frame
            RevealFade use kiya (clip-path nahi) kyunki andar sys-badge
            translateY(50%) se apne box ke bahar overflow karta hai —
            clip-path use karne se wo hamesha clip ho jata, chahe
            animation complete ho jaye */}
        <RevealFade as="div" direction="left" delay={150} duration={1.3} className={styles["image-showcase-wrapper"]}>
        ...
        <div className={styles["content-details"]}>
          <Reveal as="p" direction="right" delay={250} duration={1.2} className={styles["intro-text"]}>
