  ...
  return (
    <section className={styles["collaborate-main"]}>
      ...
      <div className={styles["header-top"]}>
        <Reveal as="div" direction="up" duration={1} className={styles["badge-icon-wrapper"]}>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="91" height="91" viewBox="0 0 91 91" fill="none">
                ...
                <path d="M42.2549 44.2549C44.464 44.2549 46.2549 42.464 46.2549 40.2549C46.2549 38.0457 44.464 36.2549 42.2549 36.2549C40.0457 36.2549 38.2549 38.0457 38.2549 40.2549C38.2549 42.464 40.0457 44.2549 42.2549 44.2549Z" stroke="#D9186A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M55.2549 54.2548V52.2548C55.2542 51.3685 54.9592 50.5075 54.4162 49.8071C53.8733 49.1066 53.113 48.6063 52.2549 48.3848" stroke="#D9186A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M49.2549 36.3848C50.1153 36.6051 50.8779 37.1055 51.4225 37.8071C51.9671 38.5087 52.2627 39.3716 52.2627 40.2598C52.2627 41.1479 51.9671 42.0108 51.4225 42.7125C50.8779 43.4141 50.1153 43.9145 49.2549 44.1348" stroke="#D9186A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </Reveal>
