          ...
          <div className={styles["header-right"]}>
            <div className={styles["icon-wrapper"]}>
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                ...
                <path d="M12.4004 10.6001L18.6004 18.4001" stroke="#FE9A00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M24.7998 6.80005L30.9998 14.8" stroke="#FE9A00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6 22H42V38C42 39.0609 41.5786 40.0783 40.8284 40.8284C40.0783 41.5786 39.0609 42 38 42H10C8.93913 42 7.92172 41.5786 7.17157 40.8284C6.42143 40.0783 6 39.0609 6 38V22Z" stroke="#FE9A00" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
